...
class AAPLDetailScreen extends StatefulWidget {
  const AAPLDetailScreen({Key? key}) : super(key: key);

  @override
  _AAPLDetailScreenState createState() => _AAPLDetailScreenState();
}
...
class _AAPLDetailScreenState extends State<AAPLDetailScreen>
  ...
  Future<void> fetchStockData() async {
    const apiKey = '789525ab330841a297b5f239048830';
    final url = Uri.parse(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Color(0xFF3557C2),
        elevation: 0,
